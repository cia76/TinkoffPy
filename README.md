...
- **Connect.py** - Подключение к Tinkoff Invest API. Проверка работы запрос/ответ: Данные тикера. Проверка работы подписок: Подписка на новые бары. [Видеоразбор >>>](https://finlab.vip/wpm/xpy/connect/)
